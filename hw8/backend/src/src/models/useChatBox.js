...
const getChatName = (name, to) => {return [name.toLowerCase(), to.toLowerCase()].sort().join('_')}
...
const findChatBox = async (ChatBoxModel, User1, User2) => {
  const chatBoxName = getChatName(User1, User2) 
...
export { validateChatBox, getChatName, findChatBox, appendMessage }